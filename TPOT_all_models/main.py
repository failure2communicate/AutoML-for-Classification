...
class Main(object): 
    def __init__(self): 
        ...
        self.model = joblib.load(os.path.join(self.cur_dir, 'model', 'model.sav'))
        self.label_encoder = None
        
        if os.path.isfile(os.path.join(self.cur_dir, 'model', 'label_encoder.sav')):
            self.label_encoder = joblib.load(os.path.join(self.cur_dir, 'model', 'label_encoder.sav'))
...
if __name__ == '__main__':
    main = Main()
    df = pd.read_csv('TPOT_all_models\\Data\\test.csv', header=None)
